    ...
    const [course, setCourse] = useState(
        {
            ...
            about: "In this course you'll learn the ins-and-outs of how Ethereum blockchain protocal operates. We'll be using the Solidity programming language to teach you how you can setup your own smart-contracts <br />Build your very own dapps on the ethereum blockchain and setup backend configs",
            tutor: {
                ID: 1,
                name: "Solana Trooper",
                username: "CryptoWizard9000",
            ...
            <div className="course-preview rel">
                ...
                <div className="extras-block rel flex">
                    ...
                    <div className="chat rel">
                        <div className="section section-b rel">                    
                            <h2 className="title s24 fontb">Download Resources <span  className="fontn">and Doc</span></h2>
                            <div className="messages aic flex">
                                <div className="bubble rel">
                                    <h2 className="txt ibl fontn s15 c333">1500 Ralie Tokens + 15 Gas Fee</h2>                                    
                                </div>
                                <div className="bubble rel">
                                    <h2 className="txt ibl fontn s15 c333">Purchase Now</h2>                                    
                                </div>
